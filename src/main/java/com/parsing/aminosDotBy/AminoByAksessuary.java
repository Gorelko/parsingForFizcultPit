...
public class AminoByAksessuary {

    public AminoByAksessuary() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://aminos.by/aksessuary/?page=1&limit=100";
      ...
      //  System.out.println(maxCountPage);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://aminos.by/aksessuary/?page="+v+"&limit=100";
