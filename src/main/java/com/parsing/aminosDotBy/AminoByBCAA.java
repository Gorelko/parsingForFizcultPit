...
public class AminoByBCAA {

    public AminoByBCAA() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://aminos.by/bcaa/?page=1&limit=100";
        Thread.sleep(1000);
      ...
      //  System.out.println(maxCountPage);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://aminos.by/bcaa/?page="+v+"&limit=100";
