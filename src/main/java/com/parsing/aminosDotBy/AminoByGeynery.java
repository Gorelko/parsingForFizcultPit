...
public class AminoByGeynery {

    public AminoByGeynery() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://aminos.by/geynery/?page=1&limit=100";
        Thread.sleep(1000);
      ...
      //  System.out.println(maxCountPage);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://aminos.by/geynery/?page="+v+"&limit=100";
