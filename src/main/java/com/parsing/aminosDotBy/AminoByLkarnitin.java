...
public class AminoByLkarnitin {

    public AminoByLkarnitin() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://aminos.by/l-karnitin/?page=1&limit=100";
     ...
     //   System.out.println(maxCountPage);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://aminos.by/l-karnitin/?page="+v+"&limit=100";
