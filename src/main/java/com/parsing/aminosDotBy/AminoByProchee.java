...
public class AminoByProchee {

    public AminoByProchee() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Прочее";


        String linkProtein = "https://aminos.by/prochee/?page=1&limit=100";
     ...
     //   System.out.println(maxCountPage);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://aminos.by/prochee/?page="+v+"&limit=100";
