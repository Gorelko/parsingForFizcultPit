...
public class AminoByProtein {

    public AminoByProtein() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://aminos.by/proteiny/?page=1&limit=100";
     ...
     //   System.out.println(maxCountPage);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
         //   System.out.println(i);
            link = "https://aminos.by/proteiny/?page="+v+"&limit=100";
