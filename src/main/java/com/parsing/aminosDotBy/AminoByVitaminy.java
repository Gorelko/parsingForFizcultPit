...
public class AminoByVitaminy {

    public AminoByVitaminy() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://aminos.by/vitaminy-i-mineraly/?page=1&limit=100";
     ...
     //   System.out.println(maxCountPage);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://aminos.by/vitaminy-i-mineraly/?page="+v+"&limit=100";
