...
public class AminoByZhiroszhigateli {

    public AminoByZhiroszhigateli() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://aminos.by/zhiroszhigateli/?page=1&limit=100";
     ...
     //   System.out.println(maxCountPage);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://aminos.by/zhiroszhigateli/?page="+v+"&limit=100";
