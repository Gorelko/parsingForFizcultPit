...
public class expertSportDotByAksessuary {

    public expertSportDotByAksessuary() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Аксессуары для спорта";


        String linkProtein = "https://expert-sport.by/katalog/odezhda-aksessuary/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/odezhda-aksessuary/?limit=100&page=" + v;
            }
