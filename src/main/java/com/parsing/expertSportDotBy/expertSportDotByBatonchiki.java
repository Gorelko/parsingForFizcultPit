...
public class expertSportDotByBatonchiki {

    public expertSportDotByBatonchiki() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Протеиновые Батончики (Печенье)";


        String linkProtein = "https://expert-sport.by/katalog/proteinovye-batonchiki-pechenje/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/proteinovye-batonchiki-pechenje/?limit=100&page=" + v;
            }
