...
public class expertSportDotByEda {

    public expertSportDotByEda() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Вкусно и полезно";


        String linkProtein = "https://expert-sport.by/katalog/vkusno-i-polezno/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/vkusno-i-polezno/?limit=100&page=" + v;
            }
