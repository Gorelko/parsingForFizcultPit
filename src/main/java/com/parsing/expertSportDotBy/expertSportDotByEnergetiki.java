...
public class expertSportDotByEnergetiki {

    public expertSportDotByEnergetiki() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Энергетики ( предтреники)";


        String linkProtein = "https://expert-sport.by/katalog/energetiki/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/energetiki/?limit=100&page=" + v;
            }
