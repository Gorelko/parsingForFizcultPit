...
public class expertSportDotByGeli {

    public expertSportDotByGeli() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Энергетические гели";


        String linkProtein = "https://expert-sport.by/katalog/energeticheskie-geli/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/energeticheskie-geli/?limit=100&page=" + v;
            }
