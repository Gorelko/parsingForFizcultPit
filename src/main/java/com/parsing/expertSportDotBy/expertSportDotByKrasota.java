...
public class expertSportDotByKrasota {

    public expertSportDotByKrasota() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Красота и здоровье";


        String linkProtein = "https://expert-sport.by/katalog/krasota-i-zdorove/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/krasota-i-zdorove/?limit=100&page=" + v;
            }
