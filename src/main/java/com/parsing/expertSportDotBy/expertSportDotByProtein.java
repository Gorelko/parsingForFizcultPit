...
public class expertSportDotByProtein {

    public expertSportDotByProtein() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://expert-sport.by/katalog/protein/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
