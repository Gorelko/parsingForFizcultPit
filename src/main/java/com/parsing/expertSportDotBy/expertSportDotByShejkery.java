...
public class expertSportDotByShejkery {

    public expertSportDotByShejkery() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Шейкеры и бутылки";


        String linkProtein = "https://expert-sport.by/katalog/shejkery-butylki/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/shejkery-butylki/?limit=100&page=" + v;
            }
