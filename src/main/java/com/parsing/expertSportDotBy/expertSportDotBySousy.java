...
public class expertSportDotBySousy {

    public expertSportDotBySousy() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Соусы. пасты. диет. питание";


        String linkProtein = "https://expert-sport.by/katalog/sousy-pasty-dieticheskoe-pitanie/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/sousy-pasty-dieticheskoe-pitanie/?limit=100&page=" + v;
            }
