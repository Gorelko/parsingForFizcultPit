...
public class expertSportDotByTestosteron {

    public expertSportDotByTestosteron() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Для повышения тестостерона";


        String linkProtein = "https://expert-sport.by/katalog/testosteron/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/testosteron/?limit=100&page=" + v;
            }
