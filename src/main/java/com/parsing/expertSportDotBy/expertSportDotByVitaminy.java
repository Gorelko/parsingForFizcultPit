...
public class expertSportDotByVitaminy {

    public expertSportDotByVitaminy() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Витамины. минералы. добавки для здоровья";


        String linkProtein = "https://expert-sport.by/katalog/vitaminy-mineraly/?limit=100";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            if (v == 1){
                ...
                link = "https://expert-sport.by/katalog/vitaminy-mineraly/?limit=100&page=" + v;
            }
