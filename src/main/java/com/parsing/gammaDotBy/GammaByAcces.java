...
public class GammaByAcces {

    public GammaByAcces() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Спортивные аксессуары";


        String linkProtein = "https://gamma.by/acces/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/acces/?limit=100&page=" + v;
