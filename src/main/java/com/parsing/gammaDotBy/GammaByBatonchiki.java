...
public class GammaByBatonchiki {

    public GammaByBatonchiki() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Батончики и питание";


        String linkProtein = "https://gamma.by/sportpit/batonchiki/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/sportpit/batonchiki/?limit=100&page=" + v;
