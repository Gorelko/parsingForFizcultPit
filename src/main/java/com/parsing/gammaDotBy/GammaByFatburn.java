...
public class GammaByFatburn {

    public GammaByFatburn() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Спортивное питание для похудения";


        String linkProtein = "https://gamma.by/sportpit/fatburn/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/sportpit/fatburn/?limit=100&page=" + v;
