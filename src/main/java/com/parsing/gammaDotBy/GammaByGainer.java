...
public class GammaByGainer {

    public GammaByGainer() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Гейнеры для массы";


        String linkProtein = "https://gamma.by/sportpit/gainer/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/sportpit/gainer/?limit=100&page=" + v;
            ...
            for (int i = 0; i < product.size(); i++) {
              ...
              //  System.out.println(productBrandElement);
                ...
                try {
                    ...
                    brandStr = String.valueOf(productBrandElement).split("<img src=\"https://gamma.by/image/cache/catalog/")[1].split("/")[0]; //бренд
                }
