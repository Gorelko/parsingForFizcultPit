...
public class GammaByIso {

    public GammaByIso() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Изотоники и углеводы";


        String linkProtein = "https://gamma.by/sportpit/iso/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/sportpit/iso/?limit=100&page=" + v;
