...
public class GammaByJoint {

    public GammaByJoint() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Добавки для суставов и связок";


        String linkProtein = "https://gamma.by/sportpit/joint/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/sportpit/joint/?limit=100&page=" + v;
