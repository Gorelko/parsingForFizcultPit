...
public class GammaByProtein {

    public GammaByProtein() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://gamma.by/sportpit/protein/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/sportpit/protein/?limit=100&page=" + v;
