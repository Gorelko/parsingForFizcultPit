...
public class GammaBySpecials {

    public GammaBySpecials() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Товары по акции";


        String linkProtein = "https://gamma.by/specials/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/specials/?limit=100&page=" + v;
