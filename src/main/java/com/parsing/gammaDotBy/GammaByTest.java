...
public class GammaByTest {

    public GammaByTest() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://gamma.by/sportpit/test/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/sportpit/test/?limit=100&page=" + v;
