...
public class GammaByVitamin {

    public GammaByVitamin() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Витамины";


        String linkProtein = "https://gamma.by/vitamin/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/vitamin/?limit=100&page=" + v;
