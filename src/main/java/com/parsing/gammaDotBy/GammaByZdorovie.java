...
public class GammaByZdorovie {

    public GammaByZdorovie() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Биологически активные добавки";


        String linkProtein = "https://gamma.by/zdorovie/?limit=100&page=1";
        Thread.sleep(1000);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://gamma.by/zdorovie/?limit=100&page=" + v;
