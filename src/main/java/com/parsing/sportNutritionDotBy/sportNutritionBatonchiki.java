...
public class sportNutritionBatonchiki {

    public sportNutritionBatonchiki() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Заменители питания и батончики";


        String link1 = "https://sport-nutrition.by/zameniteli-pitaniya-i-batonchiki";
