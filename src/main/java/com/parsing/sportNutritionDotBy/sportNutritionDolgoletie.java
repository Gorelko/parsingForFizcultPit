...
public class sportNutritionDolgoletie {

    public sportNutritionDolgoletie() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Активное долголетие";


        String link1 = "https://sport-nutrition.by/aktivnoe-dolgoletie";
