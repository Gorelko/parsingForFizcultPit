...
public class sportNutritionInventar {

    public sportNutritionInventar() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Инвентарь";


        String link1 = "https://sport-nutrition.by/inventar";
