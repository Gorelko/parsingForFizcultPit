...
public class sportNutritionLkarnitin {

    public sportNutritionLkarnitin() throws IOException, InterruptedException {
        ...
        String link1 = "https://sport-nutrition.by/l-karnitin-1";
