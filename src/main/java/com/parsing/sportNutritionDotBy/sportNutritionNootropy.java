...
public class sportNutritionNootropy {

    public sportNutritionNootropy() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Ноотропы";


        String link1 = "https://sport-nutrition.by/nootropy";
