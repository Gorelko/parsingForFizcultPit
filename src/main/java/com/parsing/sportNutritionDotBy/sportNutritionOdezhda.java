...
public class sportNutritionOdezhda {

    public sportNutritionOdezhda() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Спортивная одежда";


        String link1 = "https://sport-nutrition.by/sportivnaya-odezhda";
