...
public class sportNutritionTestosteron {

    public sportNutritionTestosteron() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Тестобустеры";


        String link1 = "https://sport-nutrition.by/povyshenie-testosterona";
