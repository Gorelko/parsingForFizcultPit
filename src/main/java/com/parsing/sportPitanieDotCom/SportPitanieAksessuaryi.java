...
public class SportPitanieAksessuaryi {

    public SportPitanieAksessuaryi() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Аксессуары";


        String linkProtein = "https://sport-pitanie.com/aksessuaryi/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/aksessuaryi/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
