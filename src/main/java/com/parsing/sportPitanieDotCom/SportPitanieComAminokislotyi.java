...
public class SportPitanieComAminokislotyi {

    public SportPitanieComAminokislotyi() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://sport-pitanie.com/aminokislotyi/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/aminokislotyi/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
