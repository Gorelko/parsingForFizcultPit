...
public class SportPitanieComBatonchiki {

    public SportPitanieComBatonchiki() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Батончики";


        String linkProtein = "https://sport-pitanie.com/batonchiki/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/batonchiki/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
