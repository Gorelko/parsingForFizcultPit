...
public class SportPitanieComCoenzyme {

    public SportPitanieComCoenzyme() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Коэнзим Q10";


        String linkProtein = "https://sport-pitanie.com/coenzyme-q10/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/coenzyme-q10/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
