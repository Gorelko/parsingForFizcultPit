...
public class SportPitanieComKollagen {

    public SportPitanieComKollagen() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Коллаген";


        String linkProtein = "https://sport-pitanie.com/kollagen/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/kollagen/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
