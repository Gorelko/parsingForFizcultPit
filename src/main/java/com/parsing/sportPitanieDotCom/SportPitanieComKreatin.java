...
public class SportPitanieComKreatin {

    public SportPitanieComKreatin() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://sport-pitanie.com/kreatin/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/kreatin/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
