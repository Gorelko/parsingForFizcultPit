...
public class SportPitanieComLglyuatamin {

    public SportPitanieComLglyuatamin() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://sport-pitanie.com/l-glyutamin/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/l-glyutamin/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
