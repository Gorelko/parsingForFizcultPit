...
public class SportPitanieComOmega {


    public SportPitanieComOmega() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Омега";


        String linkProtein = "https://sport-pitanie.com/omega/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/omega/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
