...
public class SportPitanieComProteinyi {

    public SportPitanieComProteinyi() throws IOException, InterruptedException {
        ...
        String linkProtein = "https://sport-pitanie.com/proteinyi/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
  ...
  //      System.out.println(brandList);
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/proteinyi/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
