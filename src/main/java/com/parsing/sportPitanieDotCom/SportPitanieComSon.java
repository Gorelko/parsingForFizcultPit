...
public class SportPitanieComSon {

    public SportPitanieComSon() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Препараты улучшающие сон";


        String linkProtein = "https://sport-pitanie.com/preparatyi-uluchshayushhie-son/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/preparatyi-uluchshayushhie-son/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
