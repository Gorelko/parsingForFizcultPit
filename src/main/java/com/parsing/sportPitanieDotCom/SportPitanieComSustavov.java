...
public class SportPitanieComSustavov {

    public SportPitanieComSustavov() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Средства для суставов и связок";


        String linkProtein = "https://sport-pitanie.com/sredstva-dlya-sustavov-i-svyazok/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/sredstva-dlya-sustavov-i-svyazok/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
