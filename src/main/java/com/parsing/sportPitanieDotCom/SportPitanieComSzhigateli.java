...
public class SportPitanieComSzhigateli {

    public SportPitanieComSzhigateli() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Сжигатели жира";


        String linkProtein = "https://sport-pitanie.com/szhigateli-zhira/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/szhigateli-zhira/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
