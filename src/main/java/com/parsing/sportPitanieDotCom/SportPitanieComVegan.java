...
public class SportPitanieComVegan {

    public SportPitanieComVegan() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Для вегетарианцев";


        String linkProtein = "https://sport-pitanie.com/dlya-vegetarianczev.html/?page=1&limit=48";
        Document doc1 = null;
        while (true) {
            try {
        ...
        for (int v = 1; v <= maxCountPage; v++) {
            ...
            link = "https://sport-pitanie.com/dlya-vegetarianczev.html/?page="+ v +"&limit=48";
            Document doc = null;
            while (true) {
                try {
