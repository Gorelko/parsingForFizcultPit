...
public class sportimeDotByGeineri {

    public sportimeDotByGeineri() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Гейнер";
        ...
        while (true) {
            try {
                ...
                String link = "http://sportime.by/geineri";
        ...
        for (int x = 0; x <= countPage; x++) {
            ...
            while (true) {
                try {
                    if (x==0){
                        doc = Jsoup.connect("http://sportime.by/geineri").get();
                    }else {
                        doc = Jsoup.connect("http://sportime.by/geineri?page="+ x).get();
                    }
                    Thread.sleep(1000);
                    break;
                }catch (Exception e){
