...
public class sportimeDotByJirosjigateli {

    public sportimeDotByJirosjigateli() throws IOException, InterruptedException {
        ...
        while (true) {
            try {
                ...
                String link = "hhttp://sportime.by/jirosjigateli";
        ...
        for (int x = 0; x <= countPage; x++) {
            ...
            while (true) {
                try {
                    if (x==0){
                        doc = Jsoup.connect("http://sportime.by/jirosjigateli").get();
                    }else {
                        doc = Jsoup.connect("http://sportime.by/jirosjigateli?page="+ x).get();
                    }
                    Thread.sleep(1000);
                    break;
                }catch (Exception e){
