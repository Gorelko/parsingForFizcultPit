...
public class sportimeDotBySnijenievesa {

    public sportimeDotBySnijenievesa() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Снижение веса";
        ...
        while (true) {
            try {
                ...
                String link = "http://sportime.by/snijenie-vesa";
        ...
        for (int x = 0; x <= countPage; x++) {
            ...
            while (true) {
                try {
                    if (x==0){
                        doc = Jsoup.connect("http://sportime.by/snijenie-vesa").get();
                    }else {
                        doc = Jsoup.connect("http://sportime.by/snijenie-vesa?page="+ x).get();
                    }
                    Thread.sleep(1000);
                    break;
                }catch (Exception e){
