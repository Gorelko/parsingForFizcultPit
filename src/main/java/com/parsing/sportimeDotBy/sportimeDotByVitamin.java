...
public class sportimeDotByVitamin {

    public sportimeDotByVitamin() throws IOException, InterruptedException {
        ...
        String nameProductGroup = "Витамины - минералы";
        ...
        while (true) {
            try {
                ...
                String link = "http://sportime.by/vitamini-minerali";
        ...
        for (int x = 0; x <= countPage; x++) {
            ...
            while (true) {
                try {
                    if (x==0){
                        doc = Jsoup.connect("http://sportime.by/vitamini-minerali").get();
                    }else {
                        doc = Jsoup.connect("http://sportime.by/vitamini-minerali?page="+ x).get();
                    }
                    Thread.sleep(1000);
                    break;
                }catch (Exception e){
